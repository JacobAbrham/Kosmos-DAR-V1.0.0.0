...
**Documentation:** [Legal Framework](../01-governance/legal-framework)
...
- [Legal Framework](../01-governance/legal-framework)
- [Data Protection Impact Assessment](../appendices/templates/dpia-template)
