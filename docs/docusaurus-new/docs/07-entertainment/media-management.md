...
:::info Digital Life Entertainment
...
- [HESTIA Agent](../02-architecture/agents/hestia-personal) — Personal agent
- [Personal Data Ecosystem](../06-personal-data/personal-data-ecosystem) — Data integration
