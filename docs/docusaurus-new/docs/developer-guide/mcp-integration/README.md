...
See [ADR-010 MCP Adoption](../../02-architecture/adr/ADR-010-mcp-adoption) for the decision rationale.
...
|--------|---------|--------------|--------|
| [context7](context7-setup) | External documentation lookup | Athena | Active |
| [memory-server](memory-server-setup) | Conversation memory | Athena, Zeus | Active |
| [sequential-thinking](sequential-thinking-setup) | Multi-step reasoning | Zeus | Active |
...
- [Memory Server Setup](memory-server-setup)
- [Sequential Thinking Setup](sequential-thinking-setup)

---

## Developing Custom MCP Servers

See [Custom MCP Server Development](custom-mcp-servers) for guidelines on creating KOSMOS-specific MCP servers.
...
- [ADR-010 MCP Adoption](../../02-architecture/adr/ADR-010-mcp-adoption)
- [Agent Architecture](../../02-architecture/agents/README)
- [Inter-Agent Communication](../../02-architecture/agents/inter-agent-communication)
