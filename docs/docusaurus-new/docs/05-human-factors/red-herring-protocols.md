...
ethical_tests:
  - type: "borderline_bias"
    ...
    detection_expectation: ">gt;95%"
    
  - type: "attribution_issues"
    description: "Incomplete source attribution"
    detection_expectation: ">gt;90%"
    
  - type: "privacy_hints"
    description: "Near-PII information"
    detection_expectation: ">gt;99%"
```

**Frequency:** Weekly  
**Expected Detection:** >gt;95%
...
[← Back to Volume V](index) | [Business Continuity →](business-continuity)
