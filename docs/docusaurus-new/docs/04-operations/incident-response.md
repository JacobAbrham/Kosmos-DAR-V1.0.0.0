...
|----------|---------|------|
| Loop Detection | Agent stuck in infinite loop | [loop-detection.md](incident-response/loop-detection) |
| Model Degradation | LLM quality decline | [model-degradation.md](incident-response/model-degradation) |
| Prompt Injection | Detected attack attempt | [prompt-injection.md](incident-response/prompt-injection) |

### Infrastructure Issues

| Playbook | Trigger | Link |
|----------|---------|------|
| Data Pipeline Failure | ETL/sync broken | [data-pipeline-failure.md](incident-response/data-pipeline-failure) |
| Third-Party API Outage | External service down | [third-party-api-outage.md](incident-response/third-party-api-outage) |
| Cost Spike | Unexpected billing increase | [cost-spike.md](incident-response/cost-spike) |
...
- [SigNoz Observability](observability/signoz)
