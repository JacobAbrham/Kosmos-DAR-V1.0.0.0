...
- [Pentarchy Governance](pentarchy-governance) — Multi-agent voting
- [FinOps Metrics](../04-operations/finops-metrics) — Financial operations
- [LiteLLM Configuration](../02-architecture/cloud-inference) — LLM cost routing

---

**Source:** Spec C of [Digital Agentic Realm](../00-executive/digital-agentic-realm)
