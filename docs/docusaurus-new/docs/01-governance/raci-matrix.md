...
**Related Documents:**
- [Kill Switch Protocol](kill-switch-protocol) - Emergency authority
- [Risk Registry](risk-registry) - Who owns which risks
- [Volume IV: Incident Response](../04-operations/incident-response/README) - Operational procedures

**Next:** [AI Ethics Scorecard →](ethics-scorecard)
