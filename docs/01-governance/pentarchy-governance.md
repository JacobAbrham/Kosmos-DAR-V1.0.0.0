...
!!! abstract "Multi-Agent Decision Framework"
...
- [Cost Governance](cost-governance.md) — Pre-flight cost control
- [Kill Switch Protocol](kill-switch-protocol.md) — Emergency intervention
- [Zeus Supervisor](../02-architecture/agents/zeus-orchestrator.md) — Pentarchy host

---

**Source:** Section 5.5 of [Digital Agentic Realm](../00-executive/digital-agentic-realm.md)
