...
**Current Choice:** Mermaid (see [ADR-001](../adr/ADR-001-documentation-framework.md))
...
### Internal Documents
- [System Topology](../topology.md) - Detailed component inventory
- [Data Lineage](../data-lineage.md) - Data flow diagrams
- [ADR-001: Documentation Framework](../adr/ADR-001-documentation-framework.md)
