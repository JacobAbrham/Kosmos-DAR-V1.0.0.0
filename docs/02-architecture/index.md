...
- [ADR-005: Data Storage Selection](adr/ADR-005-data-storage-selection.md)
- [ADR-006: LLM Provider Strategy](adr/ADR-006-llm-provider-strategy.md)
- [ADR-007: Observability Stack](adr/ADR-007-observability-stack.md)
- [ADR-009: LangGraph Selection](adr/ADR-009-langgraph-selection.md)
- [ADR-011: RAG Architecture](adr/ADR-011-rag-architecture.md)
- [ADR-018: Memory Architecture](adr/ADR-018-memory-architecture.md)
- [ADR-024: Security Architecture](adr/ADR-024-security-architecture.md)

### [Multi-Agent Architecture](agents/README.md)
...
1. **New Team Members** - Start with [System Topology](topology.md)
2. **Understanding Decisions** - Review [ADR index](adr/index.md)
3. **Data Engineers** - Check [Data Lineage](data-lineage.md)
4. **Visual Learners** - Explore [C4 Diagrams](c4-diagrams/README.md)
...
[← Back to Home](../index.md) | [Volume I: Governance →](../01-governance/index.md) | [Volume III: Engineering →](../03-engineering/index.md)
