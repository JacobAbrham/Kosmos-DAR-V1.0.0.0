...
- **[System Topology](../topology.md)** - Architecture implementation
- **[Volume I: Governance](../../01-governance/index.md)** - Strategic alignment
...
[← Back to ADR Index](index.md) | [Volume II: Architecture →](../index.md)
...
6. **Update the ADR index** in [index.md](index.md) when status changes
