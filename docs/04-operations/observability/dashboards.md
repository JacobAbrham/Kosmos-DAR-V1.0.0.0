...
panels:
  ...
  - title: Runbook Links
    ...
    content: |
      ## Quick Links
      - [Prompt Injection Response](../incident-response/prompt-injection.md)
      - [Model Degradation](../incident-response/model-degradation.md)
      - [Cost Spike](../incident-response/cost-spike.md)
