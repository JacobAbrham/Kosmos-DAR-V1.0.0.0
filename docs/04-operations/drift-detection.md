...
|------------|----------|----------|--------|
| Performance | >10% drop | Immediate | Emergency retrain |
...
- **[FinOps Metrics](finops-metrics.md)** - Cost impact of retraining
- **[Canary Playbooks](../03-engineering/canary-playbooks.md)** - Safe model updates
- **[Model Cards](../03-engineering/model-cards/README.md)** - Document baseline metrics
- **[SLA/SLO](sla-slo.md)** - Performance targets
...
[← Back to Volume IV](index.md) | [SLA/SLO →](sla-slo.md)
