...
See [Zitadel Identity](../security/zitadel-identity.md) for token acquisition.
...
- [ADR-008 API Versioning Strategy](../02-architecture/adr/ADR-008-api-versioning-strategy.md)
