...
```markdown
# docs/index.md
- [Templates](appendices/templates/adr-template.md)  # Add specific file

# docs/02-architecture/adr/README.md
- [Overview](README.md)  # Use explicit filename

# docs/developer-guide/python-sdk.md
- [Model Cards](../03-engineering/model-cards/README.md)  # Add README.md
```
