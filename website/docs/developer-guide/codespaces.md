...
1. Read the [Architecture Overview](../02-architecture/index)
2. Review [Agent Documentation](../02-architecture/agents/README)
3. Explore [MCP Integration](mcp-integration/README)
