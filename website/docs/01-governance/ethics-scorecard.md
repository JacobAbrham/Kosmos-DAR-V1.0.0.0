...
**Validation:** Cross-reference with [RACI Matrix](raci-matrix)
...
**Action Required:**
- Update detection rules (see [Prompt Injection Runbook](../04-operations/incident-response/prompt-injection))
...
- See [Kill Switch Protocol](kill-switch-protocol)
...
2. **Short-term (4-24 hours)**
   ...
   - Document incident ([Incident Response](../04-operations/incident-response/README))
...
See [Appendix: Metrics Glossary](../appendices/glossary#fairness-metrics)
