...
**See:** [ADR-003: Deployment Pipeline Architecture](ADR-003-deployment-pipeline)
...
- [ADR-001: Documentation Framework Selection](ADR-001-documentation-framework)
- [ADR-003: Deployment Pipeline Architecture](ADR-003-deployment-pipeline)
...
- [CONTRIBUTING.md](https://github.com/Nuvanta-Holding/kosmos-docs/blob/main/CONTRIBUTING) (to be created)
- [.github/PULL_REQUEST_TEMPLATE.md](https://github.com/Nuvanta-Holding/kosmos-docs/blob/main/.github/PULL_REQUEST_TEMPLATE) (to be created)
