...
| API abuse | Rate analysis | >gt;200% of baseline |
...
- [ADR-004: Authentication Strategy](../02-architecture/adr/ADR-004-authentication-strategy)
- [Incident Response Runbooks](../04-operations/incident-response/README)
