...
| [Falco Runtime](falco-runtime) | Runtime threat detection rules |
| [Kyverno Policies](kyverno-policies) | Kubernetes policy definitions |
| [Zitadel Identity](zitadel-identity) | Identity provider configuration |
| [Secrets Management](secrets-management) | Infisical setup and rotation |
...
The [AEGIS Security Agent](../02-architecture/agents/aegis-security) orchestrates security operations:
