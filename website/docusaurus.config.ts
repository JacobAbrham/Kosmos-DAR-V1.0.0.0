...
const config: Config = {
  ...
  organizationName: 'JacobAbrham', // Usually your GitHub org/user name.
  projectName: 'Kosmos-DAR-V1.0.0.0', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/JacobAbrham/Kosmos-DAR-V1.0.0.0/tree/master/docs/',
  ...
  plugins: [
    ...
    // PWA support for better performance
    [
  ...
  themeConfig: {
          ...
          items: [
            {
              ...
              to: '/docs/deployment/getting-started',
            },
            {
              label: 'Architecture',
    ...
    prism: {
      ...
      additionalLanguages: ['python', 'typescript', 'bash', 'yaml', 'json', 'toml'],
    },
