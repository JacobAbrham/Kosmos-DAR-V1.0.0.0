...
- [Pentarchy Governance](docs/01-governance/pentarchy-governance.md) — Multi-agent decision framework
- [Kill Switch Protocol](docs/01-governance/kill-switch-protocol.md) — Emergency intervention
